        ...
        <nav class="navbar navbar-expand-md fixed-top mb-2">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link" href="#">Physician ID :${obj.getId()}</a></li>
                </ul>
            </div>
        </nav>
        <main>
            <div class="headernav"> 
            	<a href="/physicianlogout" class="right"><input type="button" value="Logout" ></a> 
                <a href="#" class="right"><input type="button" value="TimeTable" data-toggle="modal" data-target="#timetable"></a> 
                <a href="#" class="right"><input type="button" value="ShoWPhysicians" data-toggle="modal" data-target="#physicians"></a> 
                <a href="#" class="right"><input type="button" value="Edit-profile" data-toggle="modal" data-target="#edit"></a>
                <a href="#" class="right"><input type="button" value="ShowPatients" data-toggle="modal" data-target="#patients"></a>
            </div>
                <div class="slideshow-container">
                    <img src="one.jpg" style="width:100%">
<!-- Time Table -->       <div class="container">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <table style="margin-top:10px;border-collapse: collapse;width:100%;">
												...
												<tr><td>PhysicianID</td><td>Date</td><td>Slot1</td><td>Slot2</td><td>Slot3</td><td>Slot4</td></tr>
											...
											<form action="/addTimeTable" class="form-container">
												<table style="margin-left:30px;">
													<tr><td>Add DATE : </td><td><input type="date" name="date"></td><td><input type="submit" value="Add"></td></tr>
												</table>
											</form>
                                            </div>
                            ...
                            <div class="container">
                                <div class="modal fade" id="edit" role="dialog">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                        <div class="modal-body">
                                        <form action="/editPhysicianProfile" class="form-container">
                                            	<table>
